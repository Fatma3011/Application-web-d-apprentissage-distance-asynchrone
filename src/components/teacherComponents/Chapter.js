...
function Chapter(props) {
    ...
    const [chapterState, setChapterState] = useState(data);

    const handleChapterChange = (e) => {setChapterState({
        ...chapterState,
...
// save activity---------------------
function setActivity(quiz){
  setChapterState({quiz:quiz});
  console.log(chapterState);
}



        const [questions, setQuestions]= useState(chapterState.quiz);
